 ...
 * ----------------------
 * This program allows the user to type in a font name and then
 * displays a line of text using the font.
 */
...
public class FontSampler extends GraphicsProgram {
	...
	private static final String TEST_STRING = "The quick brown fox"
